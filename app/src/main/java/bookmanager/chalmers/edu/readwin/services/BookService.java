...
public class BookService implements IBookService {
    ...
    private Book book1 = new Book(1, "The Hobbit", "J. R. R. Tolkien", "9780582186552",
            ...
            "https://images-na.ssl-images-amazon.com/images/I/61aqO0sPF%2BL._SX329_BO1,204,203,200_.jpg", "7 - 8");
    ...
    private Book book2 = new Book(2, "Alice's Adventures in Wonderland", "Lewis Carrol", "9781533345455",
            ...
            "http://t3.gstatic.com/images?q=tbn:ANd9GcSz9Z5sm0vXcZzhcPl6p_Cq53SDgFgiC8qS-Q6EPEHvSNic2eLr", "7 - 8");
    ...
    private Book book3 = new Book(3, "Moby-Dick", "Herman Melville", "9781535277181",
            ...
            "http://t0.gstatic.com/images?q=tbn:ANd9GcRVzGSCtcxuJZ51obbG92GWfkq9L7d3vIJhy5XHEr-4WoKN7FJP", "10 - 11");
    ...
    private Book book4 = new Book(4, "Oliver Twist", "Charles Dickens", "9781844280681",
            ...
            "http://t0.gstatic.com/images?q=tbn:ANd9GcTcq1eCXim9jmezfg0VZecCEVc7STUjYkI74d1nM-ansyUZ3RoN", "8 - 9");
    ...
    private Book book5 = new Book(5, "Harry Potter and the Philosopher's Stone", "J. K. Rowling", "9788700631625",
            ...
            "http://t2.gstatic.com/images?q=tbn:ANd9GcTp0w1QBM18O90jGjFPLNGoRlDfbdRG44zZa-8zokr_EocYL0z-", "8 - 9");
    ...
    private Book book6 = new Book(6, "Adventures of Huckleberry Finn", "Mark Twain", "9780886767273",
            ...
            "http://t3.gstatic.com/images?q=tbn:ANd9GcSHCuXxly3yxOR3Wfdc1usU1iAOUyc4enO5VgtuuRdaKSl4VV2M", "10 - 11");
    ...
    private Book book7 = new Book(7, "The Cat in the Hat", "Dr. Seuss", "9782371000193",
            ...
            "http://t2.gstatic.com/images?q=tbn:ANd9GcSrobA2bx30tEpLERBmMZCkBEP-bjbWdxFFWZcCal_vKEaskZ-d", "9 - 10");
    ...
    private Book book8 = new Book(8, "The Bad Beginning", "Daniel Handler", "9781405207263",
            ...
            "http://t0.gstatic.com/images?q=tbn:ANd9GcQEBB2TpgNvBwDt8ors4jxFHrPOF4pKWaaWuhLzShXe_cQGV3g0", "8 - 9");
